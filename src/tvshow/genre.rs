...
const PATH: &str = "/genre/tv/list";

/// Command to list tvshows genres
#[derive(Clone, Debug, Default)]
pub struct TVShowGenreList {
    /// ISO 639-1 value to display translated data for the fields that support it.
    pub language: Option<String>,
}

#[async_trait::async_trait]
impl crate::prelude::Command for TVShowGenreList {
...
mod tests {
    ...
    async fn it_works() {
        ...
        let cmd = TVShowGenreList::default();
...
mod integration_tests {
    ...
    async fn execute() {
        ...
        let mut cmd = TVShowGenreList::default();
        cmd.language = Some("fr-FR".into());
